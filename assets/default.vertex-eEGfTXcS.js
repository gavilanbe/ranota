import{S as e}from"./index-BEsN4R1g.js";import"./mainUVVaryingDeclaration-DZAzDAlM.js";import"./logDepthVertex-JMF7Cury.js";import"./logDepthDeclaration-X4vSkkgG.js";import"./meshUboDeclaration-BPyUsPzk.js";const n="decalVertexDeclaration",A=`#ifdef DECAL
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=p);const l="prePassVertex",h=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=h);const E="uvVariableDeclaration",R=`#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=R);const c="samplerVertexImplementation",P=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=P);const v="shadowsVertex",D=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=D);const I="vertexColorMixing",T=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=colorUpdated;
